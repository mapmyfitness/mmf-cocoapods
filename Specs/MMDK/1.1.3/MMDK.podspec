#
#  Be sure to run `pod spec lint MMDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "MiKey" => "mike.key@mapmyfitness.com", "other author" => "email@address.com" }
  # s.author       = 'MiKey', 'other author'
